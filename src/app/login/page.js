        ...
        <div className="grid grid-cols-2 gap-0 my-1 mx-1 card_style ">
          ...
          <a href="/">
           <svg style={{display:'block',font: '7rem arial', fontFamily: 'arial black',width: '100%',height: '230px',marginBottom: '-8rem',}}>
            ...
            <p className="text-center font-serif text-2xl pt-12">Welcome back! Please enter your details.</p>
            <div className="border-b-2 border-gray-500 text-center mr-2 ">
              <button style={{ background: "#5d6588",fontSize:'1.2rem' }} className="w-3/5 text-white font-serif mb-12 bg-transparent bg-gradient-to-br from-rose-500 to-green-600 hover:bg-gradient-to-bl focus:ring-1 focus:outline-none focus:ring-pink-200 dark:focus:ring-white-800 font-medium rounded-full text-sm px-24 py-5 text-center my-10">
                Log in with Google
              </button>
            </div>
            ...
            <form className="mini-form text-center mt-10">
              ...
              <div className="m-2">
              <input className="mr-3" type="checkbox" class="checked:bg-red-500 ..." />
              <a href="/" className="mr-24 text-blue-500 font-serif">Privacy Policy</a>
              <a href="#" className="text-blue-500 font-serif">Forgot password</a>
              </div>
              <button style={{ background: "#5d6588", fontSize:'1.2rem'}} className="w-3/5 text-white mb-5 font-serif bg-transparent bg-gradient-to-br from-rose-500 to-green-600 hover:bg-gradient-to-bl focus:ring-1 focus:outline-none focus:ring-pink-200 dark:focus:ring-white-800 font-medium rounded-full text-sm px-5 py-5 text-center my-5 mx-1">
                Log In Now
              </button>
            </form>
            <div className="flex ml-24 mb-10 font-serif text-md gap-2 text-center">
              <p className="ml-5">Haven’t an account? </p>
              <a  className="text-rose-500 "href="/signup">Sign up now</a>
            </div>
          </div>
          <div
